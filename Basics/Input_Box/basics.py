...
class test(QtWidgets.QApplication):
    def __init__(self):
        ...
        # returns the tuple (value,boolean value) boolean value says whether user has choosen ok or cancel button (ok-TRue and vice versa)
        f1=lambda x=True:print(QtWidgets.QInputDialog.getInt(self.window,'Get Integer','Select Some Integer',69,-69420,69420,69)) 
        f2=lambda x=True:print(QtWidgets.QInputDialog.getDouble(self.window,'Get Floating Values','Select Some Decimal',69.0,0,69.69,2))
        f3=lambda x=True:print(QtWidgets.QInputDialog.getText(self.window,'Single Line Text','Enter SomeThing'))
        f4=lambda x=True:print(QtWidgets.QInputDialog.getMultiLineText(self.window,'MultiLine Text','Some Some Lines of Text'))
        f5=lambda x=True:print(QtWidgets.QInputDialog.getItem(self.window,'Select','Select From List',['Orange','Red','Green'],editable=False))
