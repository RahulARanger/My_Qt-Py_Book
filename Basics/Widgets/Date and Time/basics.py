...
class test(QtWidgets.QApplication):
    def __init__(self):
        ...
        date=QtCore.QDate.currentDate(),# datetime.date.today() this one also works
        time=QtCore.QTime(10,0),# datetime.time(10,0) this one also works
        displayFormat='HH:mm dd-MM-yyyy', # 'H' for hours and 'm' for min and 'd,M,Y' for date month and year
