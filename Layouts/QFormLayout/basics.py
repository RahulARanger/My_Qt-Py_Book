...
class test(QtWidgets.QApplication):
    def __init__(self):
        ...
        self.firstname,self.lastname=[QtWidgets.QLineEdit(self.window,placeholderText='{}'.format(i)) for i in ['Enter your First Name','Enter your Last Name']]
        ...
        self.window.layout().setRowWrapPolicy(QtWidgets.QFormLayout.WrapAllRows) # there are lot of other options too check documentation
        self.window.show()
test().exec()